...
* [Manage Data](data/README.md)
  ...
  * [Accessing table data from applications](data/access-data-from-applications/README.md)
    ...
    * [Upload tables to Nuvolos](data/access-data-from-applications/upload-data-to-nuvolos/README.md)
      * [Small table upload scripts](data/access-data-from-applications/upload-data-to-nuvolos/small-data-upload-scripts.md)
